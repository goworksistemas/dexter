-- Backfill de cost_usd em mensagens existentes (tokens × preço cadastrado).
...
revoke all on function public.dexter_backfill_message_costs() from public;
grant execute on function public.dexter_backfill_message_costs() to service_role;

-- Mensagens antigas
select public.dexter_backfill_message_costs();
